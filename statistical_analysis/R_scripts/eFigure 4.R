...
ggsave(plot= eFigure_4a1 / eFigure_4a2, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4a.png",
       width = 12, height = 8)
...
eFigure_4b1
ggsave(plot= eFigure_4b1, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4b1.png",
       width = 12, height = 8)
eFigure_4b2 <- forest_model(model_both_Q1_adj, exponentiate = TRUE)
eFigure_4b2
ggsave(plot= eFigure_4b2, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4b2.png",
       width = 12, height = 8)
eFigure_4b3 <- forest_model(model_both_UFpos_adj, exponentiate = TRUE)
eFigure_4b3
ggsave(plot= eFigure_4b3, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4b3.png",
       width = 12, height = 8)
eFigure_4b4 <- forest_model(model_both_FBneg_adj, exponentiate = TRUE)
eFigure_4b4
ggsave(plot= eFigure_4b4, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4b4.png",
       width = 12, height = 8)


eFigure_4b5 <- forest_model(model_both_AUC_adj, exponentiate = TRUE)
eFigure_4b5
ggsave(plot= eFigure_4b5, filename = "C:\\Programming\\FLIRRT\\FLIRRT_Paper\\eFigure 4b5.png",
       width = 12, height = 8)
