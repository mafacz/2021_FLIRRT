...
ggsave(plot= heatmap_mean_48h, filename = glue("{R_output_root}/eFigure 3a\\eFigure 3a_48h.png"), bg="white", width = 6, height = 6)
ggsave(plot= heatmap_mean_Q1_FB, filename = glue("{R_output_root}/eFigure 3a\\eFigure 3a_Q1_FB.png"), bg="white", width = 6, height = 6)
ggsave(plot= heatmap_mean_UFpos, filename = glue("{R_output_root}/eFigure 3a\\eFigure 3a_UFpos.png"), bg="white", width = 6, height = 6)
ggsave(plot= heatmap_mean_FBneg, filename = glue("{R_output_root}/eFigure 3a\\eFigure 3a_FB_neg.png"), bg="white", width = 6, height = 6)
...
Heatmap_females
ggsave(plot= Heatmap_females, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Sex_F.png"), bg="white", width = 6, height = 6)
...
Heatmap_males <- plot_mortality_heatmap(data = (combined %>% dplyr::filter(gender == "M")), uf_bin_col = mean_UFnet_bin,fb_bin_col = mean_FB_bin,
                                          ...
                                          y_title = "Mean Net Ultrafiltration Rate (ml/kg/h)")
Heatmap_males
ggsave(plot= Heatmap_males, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Sex_M.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_fluidoverload_10, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Fluidoverload10.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_nofluidoverload, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_NoFluidoverload.png"), bg="white", width = 6, height = 6)
...
Heatmap_NA_increase <- plot_mortality_heatmap(data = (combined %>% dplyr::filter(Noradrenalin_increase_0.1_mcgkgmin == 1)), uf_bin_col = mean_UFnet_bin,fb_bin_col = mean_FB_bin,
                                              ...
                                              y_title = "Mean Net Ultrafiltration Rate (ml/kg/h)")
Heatmap_NA_increase
ggsave(plot= Heatmap_NA_increase, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Noradre_increase0.1.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_NA_noincrease, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Noradre_noincrease0.1.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_Lactate2_increase, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Lactate2_increase.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_Lactate2_noincrease, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Lactate2_noincrease.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_Lactate4_increase, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Lactate4_increase.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_Lactate4_noincrease, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Lactate4_noincrease.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_Anuria_onset, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Anuria_onset.png"), bg="white", width = 6, height = 6)
...
ggsave(plot= Heatmap_no_Anuria_onset, filename = glue("{R_output_root}/eFigure 3b\\eFigure 3b_mean_Anuria_noonset.png"), bg="white", width = 6, height = 6)
